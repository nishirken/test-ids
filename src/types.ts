...
export type StaticIdWithAttrs<
  T extends Record<string, any> = Record<string, any>
> = Flavor<"staticIdWithAttrs", WithAttrsString> & { __attrs?: T };
export type DynamicIdWithAttrs<
  T extends Record<string, any> = Record<string, any>
> = Flavor<"dynamicIdWithAttrs", (x: any) => WithAttrsString> & { __attrs?: T };
